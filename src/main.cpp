...
void test_video_2()
{
	...
	capture_left.open("../../video20200120/VideoLeft_rectify.avi");
	capture_right.open("../../video20200120/VideoRight_rectify.avi");
	...
	std::cout << "count: " << count << ", good: " << good_count << ", bad:" << bad_count << std::endl;
...
void test_opti()
{
	...
	for (int i = 0; i < 8; ++i)
	{
		auto [R, t, cost] = optimizator.process(left.at(i), right.at(i));
...
void capture_video()
{
	...
	capture_left.open(0);
	//capture_left.open("../../video20200120/VideoLeft.avi");
	//capture_right.open("../../video20200120/VideoRight.avi");
	...
	VideoWriter writer_left("VideoLeft_rectify.avi", cv::VideoWriter::fourcc('M', 'J', 'P', 'G'), 30.0, size);
	VideoWriter writer_right("VideoRight_rectify.avi", cv::VideoWriter::fourcc('M', 'J', 'P', 'G'), 30.0, size);
